...
var supportedLanguages = []Language{
	{Name: "Filipino", LProj: "fil.lproj", GoogleKey: "tl"},
	{Name: "Filipino (Philippines)", LProj: "fil-PH.lproj", GoogleKey: "tl"},
	{Name: "English", LProj: "en.lproj", GoogleKey: "en"},
	{Name: "English (Australia)", LProj: "en-AU.lproj", GoogleKey: "en"},
	{Name: "English (India)", LProj: "en-IN.lproj", GoogleKey: "en"},
	{Name: "English (United Kingdom)", LProj: "en-GB.lproj", GoogleKey: "en-GB"}, //
	{Name: "Spanish", LProj: "es.lproj", GoogleKey: "es"},
	{Name: "Spanish (Latin-America)", LProj: "es-419.lproj", GoogleKey: "es"},
	{Name: "French", LProj: "fr.lproj", GoogleKey: "fr"},
	{Name: "French (Canada)", LProj: "fr-CA.lproj", GoogleKey: "fr"},
	{Name: "Chinese, Simplified", LProj: "zh-Hans.lproj", GoogleKey: "zh-CN"},
	{Name: "Chinese, Traditional", LProj: "zh-Hant.lproj", GoogleKey: "zh-TW"},
	{Name: "Chinese (Hong Kong)", LProj: "zh-HK.lproj", GoogleKey: "zh-CN"},
	{Name: "Japanese", LProj: "ja.lproj", GoogleKey: "ja"},
	{Name: "Germany", LProj: "de.lproj", GoogleKey: "de"},
	{Name: "Russian", LProj: "ru.lproj", GoogleKey: "ru"},
	{Name: "Portugese (Portugal)", LProj: "pt-PT.lproj", GoogleKey: "pt-PT"},
	{Name: "Portugese (Brazil)", LProj: "pt-BR.lproj", GoogleKey: "pt-BR"},
	{Name: "Italian", LProj: "it.lproj", GoogleKey: "it"},
	{Name: "Korean", LProj: "ko.lproj", GoogleKey: "ko"},
	{Name: "Arabic", LProj: "ar.lproj", GoogleKey: "ar"},
	{Name: "Turkish", LProj: "tr.lproj", GoogleKey: "tr"},
	{Name: "Thailand", LProj: "th.lproj", GoogleKey: "th"},
	{Name: "Dutch", LProj: "nl.lproj", GoogleKey: "nl"},
	{Name: "Swedish", LProj: "sv.lproj", GoogleKey: "sv"},
	{Name: "Danish", LProj: "da.lproj", GoogleKey: "da"},
	{Name: "Vietnamese", LProj: "vi.lproj", GoogleKey: "vi"},
	{Name: "Norgwegian", LProj: "nb.lproj", GoogleKey: "no"},
	{Name: "Polish", LProj: "pl.lproj", GoogleKey: "pl"},
	{Name: "Finnish", LProj: "fi.lproj", GoogleKey: "fi"},
	{Name: "Indonesian", LProj: "id.lproj", GoogleKey: "id"},
	{Name: "Hebrew", LProj: "he.lproj", GoogleKey: "he"},
	{Name: "Greek", LProj: "el.lproj", GoogleKey: "el"},
	{Name: "Romanian", LProj: "ro.lproj", GoogleKey: "ro"},
	{Name: "Hungarian", LProj: "hu.lproj", GoogleKey: "hu"},
	{Name: "Czech", LProj: "cs.lproj", GoogleKey: "cs"},
	{Name: "Catalan", LProj: "ca.lproj", GoogleKey: "ca"},
	{Name: "Slovak", LProj: "sk.lproj", GoogleKey: "sk"},
	{Name: "Ukranian", LProj: "uk.lproj", GoogleKey: "uk"},
	{Name: "Croatian", LProj: "hr.lproj", GoogleKey: "hr"},
	{Name: "Malay", LProj: "ms.lproj", GoogleKey: "ms"},
	{Name: "Hindi", LProj: "hi.lproj", GoogleKey: "hi"},
}
...
func isTranslatableString(str string) bool {
	...
	var invalidSubstrings = []string{"/", "\\", "{", "}", "_", "#", "%", ".swift", ".xib", ".storyboard", ".jpg", ".jpeg", ".png", ".mp4", ".mp3", ".wav", ".mov", ".gif", "http", "https", ".com", "identifier"} //these strings are not allowed in a string to be put in constant or translated
	for _, subStr := range invalidSubstrings {
		if strings.Contains(strings.ToLower(str), subStr) { //if lowerCased(str) contains invalid substring, then str is invalid
			return false
		}
